        ...
        const { data, error } = await resend.emails.send({
            ...
            <ul>
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="${htmlLink}" style="background-color: #2563EB; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">View HTML Report</a>
                </div>
                ` : ''}
